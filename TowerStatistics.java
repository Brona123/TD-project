...
public class TowerStatistics {
    ...
    public static Statistic getStatisticsObject(AssetLoader.TOWER_TEXTURE texture) {
        switch (texture) {
            case SHADOW:
                return new Statistic(5, 4, 500);
            case LIGHTNING:
                return new Statistic(10, 6, 2000);
            case ICE:
                return new Statistic(3, 3, 1000);
            case POISON:
                return new Statistic(3, 5, 1500);
            case SHADOW_MAGE_IDLE:
                return new Statistic(10, 5, 50);
            case DWARF_IDLE:
                return new Statistic(20, 10, 200);
            default:
                return null;
        }
    }
    ...
    public static class Statistic {
        ...
        public Statistic(int damage, int radius, int cooldown) {
            this.damage = damage;
            this.radius = radius;
